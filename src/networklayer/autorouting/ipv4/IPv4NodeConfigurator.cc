...
EXECUTE_ON_STARTUP(
    ASSERT(NEWSTAGE_L3_IPADDRESSES >= NEWSTAGE_LOCAL_INITIALIZATION);
    ASSERT(NEWSTAGE_L3_IPADDRESSES >= NEWSTAGE_L3_INITIALIZATION);
);

int IPv4NodeConfigurator::numInitStages() const { return NEWSTAGE_L3_IPADDRESSES + 1; }
