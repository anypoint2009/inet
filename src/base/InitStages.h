...
NEWSTAGE_PHYSICALENV_INITIALIZATION,
    STAGE_DO_ASSIGN_MOBILITY_COORDINATOR = 2,
    STAGE_DO_TRACI_LAUNCH = 2,

NEWSTAGE_PHYSICALENV_1 = 3,
    STAGE_DO_INITIALIZE_AND_PUBLISH_LOCATION = 3,

NEWSTAGE_L1_INITIALIZATION,
    STAGE_DO_PUBLISH_RADIOSTATE = 4,
    STAGE_DO_REGISTER_RADIO = 4,  //in ChannelController

    // stage 1
NEWSTAGE_L2_INITIALIZATION,
    STAGE_DO_REGISTER_INTERFACE = 5,
    STAGE_DO_GENERATE_MACADDRESS = 5,

    // stage 2
NEWSTAGE_L3_INITIALIZATION,
    STAGE_DO_IPV6ROUTINGTABLE_XMIPV6_SETTINGS = 6, //1,
    STAGE_DO_ADD_IP_PROTOCOLDATA_TO_INTERFACEENTRY = 6, //2,
    STAGE_DO_COMPUTE_IP_AUTOCONFIGURATION = 6, //2,

    // stage 3
NEWSTAGE_L3_IPADDRESSES,
    STAGE_DO_CONFIGURE_IP_ADDRESSES = 7, //3,

    // stage 4
NEWSTAGE_L3_STATICROUTES,
    STAGE_DO_ADD_STATIC_ROUTES = 8, //4,
    STAGE_DO_SET_INTERFACEENTRY_RTR_ADV_INTERVAL = 8, //4,
    STAGE_DO_ASSIGN_ROUTERID = 8, //4,

NEWSTAGE_TRANSPORT,
    STAGE_DO_REGISTER_TRANSPORTPROTOCOLID_IN_IP = 9, //1,

    // stage 5
NEWSTAGE_ROUTING,
    STAGE_DO_INIT_ROUTING_PROTOCOLS = 10, //5,

    // stage 6
NEWSTAGE_APPLICATIONS,
    STAGE_DO_INIT_APPLICATION = 11, //6,
    ...
    STAGE_NOTIFICATIONBOARD_AVAILABLE = 0, // note: it is ready right after it constructor call... //STAGE_DO_LOCAL + 1,      // The NotificationBoard ready for calling the subscribe() and fireChangeNotification() functions
