...
NEWSTAGE_L2_PUBLISH_STATE,
    STAGE_DO_PUBLISH_RADIOSTATE = 2,
    STAGE_DO_INITIALIZE_AND_PUBLISH_LOCATION = 2,
NEWSTAGE_L2_REGISTER_RADIO,
    STAGE_DO_REGISTER_RADIO = 3,

    // stage 2
NEWSTAGE_L3_INITIALIZATION,
    STAGE_DO_IPV6ROUTINGTABLE_XMIPV6_SETTINGS = 4, //1,
    STAGE_DO_ADD_IP_PROTOCOLDATA_TO_INTERFACEENTRY = 4, //2,
    STAGE_DO_COMPUTE_IP_AUTOCONFIGURATION = 4, //2,

    // stage 3
NEWSTAGE_L3_IPADDRESSES,
    STAGE_DO_CONFIGURE_IP_ADDRESSES = 5, //3,

    // stage 4
NEWSTAGE_L3_STATICROUTES,
    STAGE_DO_ADD_STATIC_ROUTES = 6, //4,
    STAGE_DO_SET_INTERFACEENTRY_RTR_ADV_INTERVAL = 6, //4,
    STAGE_DO_ASSIGN_ROUTERID = 6, //4,

NEWSTAGE_TRANSPORT,
    STAGE_DO_REGISTER_TRANSPORTPROTOCOLID_IN_IP = 7, //1,

    // stage 5
NEWSTAGE_ROUTING,
    STAGE_DO_INIT_ROUTING_PROTOCOLS = 8, //5,

    // stage 6
NEWSTAGE_APPLICATIONS,
    STAGE_DO_INIT_APPLICATION = 9, //6,
