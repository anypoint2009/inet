...
NEWSTAGE_PHYSICALENV_1 = 2,
    STAGE_DO_INITIALIZE_AND_PUBLISH_LOCATION = 2,

NEWSTAGE_L1_INITIALIZATION,
    STAGE_DO_PUBLISH_RADIOSTATE = 3,
    STAGE_DO_REGISTER_RADIO = 3,  //in ChannelController

    // stage 1
NEWSTAGE_L2_INITIALIZATION,
    STAGE_DO_REGISTER_INTERFACE = 4,
    STAGE_DO_GENERATE_MACADDRESS = 4,
    STAGE_DO_SUBSCRIBE_TO_RADIOSTATE_NOTIFICATIONS = 4,

    // stage 2
NEWSTAGE_L3_INITIALIZATION,
    STAGE_DO_IPV6ROUTINGTABLE_XMIPV6_SETTINGS = 5, //1,
    STAGE_DO_ADD_IP_PROTOCOLDATA_TO_INTERFACEENTRY = 5, //2,
    STAGE_DO_COMPUTE_IP_AUTOCONFIGURATION = 5, //2,

    // stage 3
NEWSTAGE_L3_IPADDRESSES,
    STAGE_DO_CONFIGURE_IP_ADDRESSES = 6, //3,

    // stage 4
NEWSTAGE_L3_STATICROUTES,
    STAGE_DO_ADD_STATIC_ROUTES = 7, //4,
    STAGE_DO_SET_INTERFACEENTRY_RTR_ADV_INTERVAL = 7, //4,
    STAGE_DO_ASSIGN_ROUTERID = 7, //4,

NEWSTAGE_TRANSPORT,
    STAGE_DO_REGISTER_TRANSPORTPROTOCOLID_IN_IP = 8, //1,

    // stage 5
NEWSTAGE_ROUTING,
    STAGE_DO_INIT_ROUTING_PROTOCOLS = 9, //5,

    // stage 6
NEWSTAGE_APPLICATIONS,
    STAGE_DO_INIT_APPLICATION = 10, //6,
